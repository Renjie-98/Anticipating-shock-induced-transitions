...
% ============================================================
    ...
    predData = evalin('base', predVar);
     %% ---the added (begin) ---  
    obsData(:,1,:) = [];
    % We remove the unperturbed initial state since it is not a steady state.
     %% ---the added (end) ---
    ...
    %ylimRange = [0 16];  % M
    %ylimRange = [0 1.6];  % E
    %ylimRange = [-30 30];   % S1 S3 
    %ylimRange = [-0.6 -0.2];   % S2
    %ylimRange = [0 0.4];   % NV1 NV3
    %ylimRange = [0 0.8];   % NV2
    %ylimRange = [0 0.016];  % R
    %ylimRange = [0 12];   % P
    %ylimRange = [0 10];   % N
