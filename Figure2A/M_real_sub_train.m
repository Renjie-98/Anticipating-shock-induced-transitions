...
nnlros = 1416;                    % model parameter

%P708 %1416
%NV 19   37

num_reali = 100;             % number of realizations per initial condition
num_x0 = 100;                % number of initial conditions
x_0 = 0;                       % baseline inPitial state （not real）
sigma  = 1;                  % noise amplitude for initial conditions

for perturbation_type = 2:2 % loop over perturbation types
